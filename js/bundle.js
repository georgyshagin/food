...
function forms(formSelector, modalTimerId) {
    ...
    function bindPostData(form) {
        form.addEventListener('submit', (e) => {
            ...
            statusMessage.src = message.loading;                        /* установка атрибута src */
    ...
    // Благодарность после успешной отправки
...
function timer(id, deadline) {
    // Timer
    // Рассчитывает время до окончания
    ...
    // Добавляет ноль к однозначным цифрам
    ...
    // Связывает переменные и элементы на странице
    ...
    function setClock(selector, endtime) {
        ...
        // Записывает значения переменных в элементы, которые есть на странице
...
/* harmony export */ });
// Настраивает, посылает запрос, трансформирует ответ в json
...
/* harmony import */ var _modules_carousel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/carousel */ "./js/modules/carousel.js");
